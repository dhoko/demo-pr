...
export const getOnDayString = (date: Date, monthlyType: MONTHLY_TYPE) => {
    ...
    if (monthlyType === MONTHLY_TYPE.ON_NTH_DAY) {
        ...
        if (setPos === 1) {
            if (day === 0) {
                return c("Monthly recurring event, repeats on")
                    .t`on the first Sunday`;
            }
            if (day === 1) {
                return c("Monthly recurring event, repeats on")
                    .t`on the first Monday`;
            }
            if (day === 2) {
                return c("Monthly recurring event, repeats on")
            ...
            if (day === 3) {
                return c("Monthly recurring event, repeats on")
                    .t`on the first Wednesday`;
            }
            if (day === 4) {
                return c("Monthly recurring event, repeats on")
                    .t`on the first Thursday`;
            }
            if (day === 5) {
                return c("Monthly recurring event, repeats on")
                    .t`on the first Friday`;
            }
            if (day === 6) {
                return c("Monthly recurring event, repeats on")
                    .t`on the first Saturday`;
            }
        }
        if (setPos === 2) {
            if (day === 0) {
                return c("Monthly recurring event, repeats on")
                    .t`on the second Sunday`;
            }
            if (day === 1) {
                return c("Monthly recurring event, repeats on")
                    .t`on the second Monday`;
            }
            if (day === 2) {
                return c("Monthly recurring event, repeats on")
                    .t`on the second Tuesday`;
            }
            if (day === 3) {
                return c("Monthly recurring event, repeats on")
                    .t`on the second Wednesday`;
            }
            if (day === 4) {
                return c("Monthly recurring event, repeats on")
                    .t`on the second Thursday`;
            }
            if (day === 5) {
                return c("Monthly recurring event, repeats on")
                    .t`on the second Friday`;
            }
            if (day === 6) {
                return c("Monthly recurring event, repeats on")
                    .t`on the second Saturday`;
            }
        }
        if (setPos === 3) {
            if (day === 0) {
                return c("Monthly recurring event, repeats on")
                    .t`on the third Sunday`;
            }
            if (day === 1) {
                return c("Monthly recurring event, repeats on")
                    .t`on the third Monday`;
            }
            if (day === 2) {
                return c("Monthly recurring event, repeats on")
                    .t`on the third Tuesday`;
            }
            if (day === 3) {
                return c("Monthly recurring event, repeats on")
                    .t`on the third Wednesday`;
            }
            if (day === 4) {
                return c("Monthly recurring event, repeats on")
                    .t`on the third Thursday`;
            }
            if (day === 5) {
                return c("Monthly recurring event, repeats on")
                    .t`on the third Friday`;
            }
            if (day === 6) {
                return c("Monthly recurring event, repeats on")
                    .t`on the third Saturday`;
            }
        }
        if (setPos === 4) {
            if (day === 0) {
            ...
            if (day === 1) {
                return c("Monthly recurring event, repeats on")
                    .t`on the fourth Monday`;
            }
            if (day === 2) {
                return c("Monthly recurring event, repeats on")
                    .t`on the fourth Tuesday`;
            }
            if (day === 3) {
                return c("Monthly recurring event, repeats on")
                    .t`on the fourth Wednesday`;
            }
            if (day === 4) {
                return c("Monthly recurring event, repeats on")
                    .t`on the fourth Thursday`;
            }
            if (day === 5) {
                return c("Monthly recurring event, repeats on")
                    .t`on the fourth Friday`;
            }
            if (day === 6) {
                return c("Monthly recurring event, repeats on")
                    .t`on the fourth Saturday`;
            }
        }
    }
    if (monthlyType === MONTHLY_TYPE.ON_MINUS_NTH_DAY) {
        if (day === 0) {
            return c("Monthly recurring event, repeats on")
                .t`on the last Sunday`;
        }
        if (day === 1) {
            return c("Monthly recurring event, repeats on")
                .t`on the last Monday`;
        }
        if (day === 2) {
            return c("Monthly recurring event, repeats on")
                .t`on the last Tuesday`;
        }
        if (day === 3) {
            return c("Monthly recurring event, repeats on")
                .t`on the last Wednesday`;
        }
        if (day === 4) {
            return c("Monthly recurring event, repeats on")
                .t`on the last Thursday`;
        }
        if (day === 5) {
            return c("Monthly recurring event, repeats on")
                .t`on the last Friday`;
        }
        if (day === 6) {
            return c("Monthly recurring event, repeats on")
                .t`on the last Saturday`;
        }
    }
...
const getCustomDailyString = (
    ...
    if (endType === END_TYPE.AFTER_N_TIMES) {
        ...
        if (interval === 1) {
            return c("Daily recurring event, frequency")
                .t`Daily, ${timesString}`;
        }
        return c("Daily recurring event, frequency")
            .t`Every ${interval} days, ${timesString}`;
    }
    ...
    if (endType === END_TYPE.UNTIL && until) {
        ...
        return c("Daily recurring event, frequency")
            .t`Every ${interval} days, ${untilString}`;
    }
};
...
const getCustomWeeklyString = (
    ...
    if (endType === END_TYPE.NEVER) {
        ...
        if (interval === 1) {
            return c("Weekly recurring event, frequency")
                .t`Weekly on ${multipleDaysString}`;
        }
        return c("Weekly recurring event, frequency").ngettext(
    ...
    if (endType === END_TYPE.AFTER_N_TIMES) {
        ...
        if (days.length === 7) {
            if (interval === 1) {
                return c("Weekly recurring event, frequency")
                    .t`Weekly on all days, ${timesString}`;
            }
            return c("Weekly recurring event, frequency").ngettext(
        ...
        if (days.length === 1) {
            ...
            if (startDate === 0) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Sunday, ${timesString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 1) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Monday, ${timesString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 2) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Tuesday, ${timesString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 3) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Wednesday, ${timesString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 4) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Thursday, ${timesString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 5) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Friday, ${timesString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 6) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Saturday, ${timesString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
        ...
        if (interval === 1) {
            return c("Weekly recurring event, frequency")
                .t`Weekly on ${multipleDaysString}, ${timesString}`;
        }
        return c("Weekly recurring event, frequency").ngettext(
    ...
    if (endType === END_TYPE.UNTIL && until) {
        ...
        if (days.length === 7) {
            if (interval === 1) {
                return c("Weekly recurring event, frequency")
                    .t`Weekly on all days, ${untilString}`;
            }
            return c("Weekly recurring event, frequency").ngettext(
        ...
        if (days.length === 1) {
            ...
            if (startDate === 0) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Sunday, ${untilString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 1) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Monday, ${untilString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 2) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Tuesday, ${untilString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 3) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Wednesday, ${untilString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 4) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Thursday, ${untilString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 5) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Friday, ${untilString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
            ...
            if (startDate === 6) {
                if (interval === 1) {
                    return c("Weekly recurring event, frequency")
                        .t`Weekly on Saturday, ${untilString}`;
                }
                return c("Weekly recurring event, frequency").ngettext(
        ...
        if (interval === 1) {
            return c("Weekly recurring event, frequency")
                .t`Weekly on ${multipleDaysString}, ${untilString}`;
        }
        return c("Weekly recurring event, frequency").ngettext(
...
const getCustomMonthlyString = (
    ...
    if (endType === END_TYPE.NEVER) {
        if (interval === 1) {
            return c("Monthly recurring event, frequency")
                .t`Monthly ${onDayString}`;
        }
    ...
    if (endType === END_TYPE.AFTER_N_TIMES) {
        ...
        if (interval === 1) {
            return c("Monthly recurring event, frequency")
                .t`Monthly ${onDayString}, ${timesString}`;
        }
        return c("Monthly recurring event, frequency").ngettext(
    ...
    if (endType === END_TYPE.UNTIL && until) {
        ...
        if (interval === 1) {
            return c("Monthly recurring event, frequency")
                .t`Monthly ${onDayString}, ${untilString}`;
        }
        return c("Monthly recurring event, frequency").ngettext(
...
const getCustomYearlyString = (
    ...
    if (endType === END_TYPE.AFTER_N_TIMES) {
        const timesString = getTimesString(count);
        if (interval === 1) {
            return c("Yearly recurring event, frequency")
                .t`Yearly, ${timesString}`;
        }
        return c("Yearly recurring event, frequency").ngettext(
...
export const getFrequencyString = (
    ...
    dtstart: VcalDateOrDateTimeProperty,
    {
        weekStartsOn,
        locale,
    }: Pick<GetTimezonedFrequencyStringOptions, "weekStartsOn" | "locale">
) => {
