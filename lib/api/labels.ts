...
export const checkLabelAvailability = (params: {
    Name: string;
    Type: LABEL_TYPE;
    ParentID?: string | number;
}) => ({
...
export const orderFolders = (opt: PartialLabelOrderArgument) =>
    order({ ...opt, Type: MESSAGE_FOLDER });
export const orderLabels = (opt: PartialLabelOrderArgument) =>
    order({ ...opt, Type: MESSAGE_LABEL });
export const orderContactGroup = (opt: PartialLabelOrderArgument) =>
    order({ ...opt, Type: CONTACT_GROUP });

export const createLabel = (opt: PartialCreateLabelArgument) =>
    create({ ...opt, Type: MESSAGE_LABEL });
export const createContactGroup = (opt: PartialCreateLabelArgument) =>
    create({ ...opt, Type: CONTACT_GROUP });
