...
export const reactivateCalendarKey = (
    calendarID: string,
    keyID: string,
...
export const resetCalendarGroup = (data: {
    CalendarKeys: CalendarKeysResetData;
}) => ({
    url: `${CALENDAR_V1}/keys/reset`,
    method: "post",
    data,
...
export const addMember = (
    calendarID: string,
    data: { Members: CalendarMemberData[] }
) => ({
    url: `${CALENDAR_V1}/${calendarID}`,
    method: "post",
    data,
...
export const updateMember = (
    calendarID: string,
    memberID: string,
    data: { Member: Partial<CalendarMemberData> }
) => ({
...
export const createEvent = (
    calendarID: string,
    data: CreateSingleCalendarEventData
) => ({
    url: `${CALENDAR_V1}/${calendarID}/events`,
    method: "post",
    data,
...
export const updatePersonalEventPart = (
    calendarID: string,
    eventID: string,
    data: CreateSinglePersonalEventData
) => ({
...
export const updateCalendarUserSettings = (
    data: Partial<CalendarUserSettings>
) => ({
    url: "settings/calendar",
    method: "put",
    data,
...
export const getVtimezones = (Timezones: string[]) => ({
    ...
    url: `${CALENDAR_V1}/vtimezones?${Timezones.map(
        (tzid) => `Timezones[]=${tzid}`
    ).join("&")}`,
    method: "get",
    // params: { Timezones }
...
export const queryCalendarAlarms = (
    calendarID: string,
    params: QueryCalendarAlarms
) => ({
...
export const syncMultipleEvents = (
    calendarID: string,
    data: SyncMultipleEventsData
) => ({
