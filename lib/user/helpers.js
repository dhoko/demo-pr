...
export const isSubUser = ({ OrganizationPrivateKey }) =>
    typeof OrganizationPrivateKey !== "undefined";
export const isDelinquent = ({ Delinquent }) => !!Delinquent;
export const getHasNonDelinquentScope = ({ Delinquent }) =>
    Delinquent < UNPAID_STATE.DELINQUENT;
export const canPay = (user) =>
    [ADMIN_ROLE, FREE_ROLE].includes(user.Role) && !isSubUser(user);
